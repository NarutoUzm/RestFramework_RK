...
public class ExcelUtility {
    ...
    public Iterator<Object[]> getApiTestData(Method method) throws IOException {
        return excelAPIDataReader("lib/APIDetailsSheet.xlsx",method.getName());
    }
    public static final Iterator<Object[]> excelAPIDataReader( String filepath, String testCaseName)
            throws IOException{
